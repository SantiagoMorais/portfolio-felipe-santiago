...
export const PortfolioList = ({
  ...
  return (
    <section className="flex w-full flex-col items-center gap-4 md:flex-row md:items-start md:gap-8">
      <ul className="flex w-full flex-wrap items-center justify-center gap-2 md:sticky md:top-[calc(var(--header-height)+30px)] md:max-h-[calc(100vh-var(--header-height))] md:w-fit md:flex-col">
