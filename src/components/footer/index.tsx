...
import { RoutesList } from "../header/header-content/routes-list";
      ...
      <section className="flex w-full flex-col items-center gap-4 py-4 md:flex-row md:justify-between md:px-16">
        ...
        <div className="flex w-full flex-1 flex-col items-center gap-4">
          <p className="text-muted-foreground w-full max-w-80 text-justify text-sm">
            Felipe Santiago é Desenvolvedor Web FullStack, especializado em
            criar sites e sistemas personalizados para ajudar empresas e
            micronegócios a se destacar no digital, com foco em resultados e na
        ...
        <RoutesList
          resumes={resumes}
          className="flex-row flex-wrap justify-center pt-0 md:flex-col"
        />
      </section>
      <Separator />
